		...
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90">
				<form class="login100-form validate-form flex-sb flex-w" action = "inserir.php" method="POST">
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate = "Nome Cliente é necessário">
						<input class="input100" type="text" name="nome" placeholder="Cliente">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-16" data-validate = "Numero OS é necessário">
						<input class="input100" type="text" name="numero_os" placeholder="Numero OS">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-16" data-validate = "Equipamento é necessário">
						<input class="input100" type="text" name="equipa" placeholder="Equipamento">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-16" data-validate = "Status é necessário">
